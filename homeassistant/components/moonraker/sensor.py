...
SENSOR_TYPES = (
    ...
    MoonrakerSensorDescription(
        ...
        name="Extruder Power",
        signal=SIGNAL_UPDATE_EXTRUDER,
        value=lambda params: round(params["power"] * 100.0, 1),
    ...
    MoonrakerSensorDescription(
        ...
        name="Print State",
        signal=SIGNAL_UPDATE_PRINT_STATUS,
        value=lambda params: params["state"],
        entity_registry_enabled_default=True,
    ...
    MoonrakerSensorDescription(
        key="current_z",
        name="Current Z",
        signal=SIGNAL_UPDATE_TOOLHEAD,
        value=lambda params: params["position"][2],
        entity_registry_enabled_default=False,
    ...
    MoonrakerSensorDescription(
        ...
        name="Homed Axes",
        signal=SIGNAL_UPDATE_TOOLHEAD,
        value=lambda params: params["homed_axes"],
        entity_registry_enabled_default=False,
        icon="mdi:axis-arrow",
    ),
    MoonrakerSensorDescription(
        key="fan_speed",
        name="Fan Speed",
        signal=SIGNAL_UPDATE_FAN,
        value=lambda params: round(params["speed"] * 100.0, 1),
        entity_registry_enabled_default=False,
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:power",
    ...
    MoonrakerSensorDescription(
        key="display_status",
        name="Display Status",
        signal=SIGNAL_UPDATE_DISPLAY_STATUS,
        value=lambda params: params["message"],
        entity_registry_enabled_default=False,
    ),
    MoonrakerSensorDescription(
        ...
        signal=SIGNAL_UPDATE_DISPLAY_STATUS,
        value=lambda params: round(float(params["progress"]) * 100.0, 1),
        entity_registry_enabled_default=False,
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
