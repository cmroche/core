...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("extruder_power", SIGNAL_UPDATE_EXTRUDER, "power", 0.99, "99.0"),
        ...
        ("bed_power", SIGNAL_UPDATE_HEAT_BED, "power", 0.99, "99.0"),
        ...
        ("print_state", SIGNAL_UPDATE_PRINT_STATUS, "state", "printing", "printing"),
        ("current_z", SIGNAL_UPDATE_TOOLHEAD, "position", [0.0, 1.1, 2.2, 3.3], "2.2"),
        ("homed_axes", SIGNAL_UPDATE_TOOLHEAD, "homed_axes", "xyz", "xyz"),
        ("fan_speed", SIGNAL_UPDATE_FAN, "speed", 0.99, "99.0"),
        (
            "display_status",
            SIGNAL_UPDATE_DISPLAY_STATUS,
            "message",
...
async def test_generic_sensors(
    hass: HomeAssistant,
    mock_connector: Mock,
    name: str,
    signal: str,
